defmodule ElixirReactTestWeb.Router do
  use ElixirReactTestWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ElixirReactTestWeb.Layouts, :root}
  ...
  if Application.compile_env(:elixir_react_test, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ElixirReactTestWeb.Telemetry
